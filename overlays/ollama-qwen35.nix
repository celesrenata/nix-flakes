...
in
{
  ollama = goBuild {
    ...
    src = fetchFromGitHub {
      owner = "ollama";
      repo = "ollama";
      rev = "afb4c62fbf6839319dbe93c1bbb9eb7fc9a67c3e";
      hash = "sha256-Zc/dGHo5hVrN458pQEkJllqSFtzo+CA4mCwzOCBTzT0=";
    };
    ...
    postPatch = ''
      substituteInPlace version/version.go --replace-fail 0.0.0 '0.17.7-main'
      rm -r app
    '';
    ...
    ldflags = [
      "-X=github.com/ollama/ollama/version.Version=0.17.7-main"
