#!/usr/bin/env python3
# =============================================================================
# Package Version Comparison Script (Full 10,000+ Packages)
# =============================================================================
# Compares ALL packages between current esnixi system and experimental flake build.
# Uses full package dependency trees (~10,000+ packages each).
#
# Input Files:
#   - current_esnixi_full.txt    (10,474 packages from current esnixi)
#   - experimental_full_packages.txt (11,325 packages from experimental build)
#
# Output: /home/celes/sources/nix-flakes-experimental/packages_comparison_full.csv
...
def main():
    ...
    exp_system_path = Path('/home/celes/sources/nix-flakes-experimental/experimental_full_packages.txt')
    output_csv = Path('/home/celes/sources/nix-flakes-experimental/packages_comparison_full.csv')
    
    print("=" * 70)
    print("PACKAGE VERSION COMPARISON SCRIPT (FULL 10,000+ PACKAGES)")
    print("=" * 70)
    print()
    ...
    if versions_diff > 0:
        ...
        count = 0
        for row in rows:
            if "DIFFERENT" in row['status'] and count < 10:
