...

{
  ...
  # Override default keybinds (esnixi uses its own Ctrl+Shift+Super scheme in host.lua)
  xdg.configFile."hypr/hyprland/keybinds.lua".source = lib.mkForce ../esnixi/hypr-lua/hyprland/keybinds-stub.lua;
