# Hyprland configuration for nixbox (VirtualBox/VMware x86_64 VM)
...

{
  ...
  # dots-hyprland configuration for nixbox
  ...
  # nixbox host config — uses standard keybinds from dots-hyprland + VM-specific host.lua
  home.file.".config/hypr/hyprland/host.lua".source = ../vm-x86/hypr-lua/nixbox.lua;
}
